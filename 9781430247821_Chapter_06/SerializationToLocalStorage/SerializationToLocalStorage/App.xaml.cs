...
using SerializationToLocalStorage.Resources;
...
namespace SerializationToLocalStorage
{
    public partial class App : Application
    {
        ...
        private static void SaveObject<T>(string fileName, T obj)
        {
        ...
        private static async Task<T> LoadObject<T>(string fileName)
        {
            T obj = default(T);
            try
            {
        ...
        {
            var myObject = await LoadObject<MyObject>("myfile.xml");
            if (myObject != null)
            {
                Debug.WriteLine(myObject.Title + " (" + myObject.Id + ") last updated " +
                    myObject.LastUpdate.ToLongTimeString());
            }
        }
        ...
        private void Application_Closing(object sender, ClosingEventArgs e)
        {
            ...
            SaveObject<MyObject>("myfile.xml", myObject);
        }
